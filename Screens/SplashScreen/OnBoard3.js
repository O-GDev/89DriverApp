...
<Text style={{alignSelf:'center',fontWeight:'bold',justifyContent:'center',paddingTop:20,position:'relative',color:'#1b1b1b'}}>Earn Money</Text>
 ...
 <TouchableOpacity  onPress={handleSkip} style={{alignSelf:'center',backgroundColor:'#2662FA',width:'50%',padding:5,borderRadius:5,position:'relative',height:40,justifyContent:'center'}}><Text style={{color:'white',fontWeight:'bold',alignSelf:'center',fontSize:20}}>GET STARTED</Text></TouchableOpacity>
        </Pressable>
    </SafeAreaView>
